        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{URL('/')}}"
                   title="Página Inicial" style="margin-top: -3px">
                    <img src="{{URL::asset('imagens/favicon-32x32.png')}}"></a>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right" id="link-white">
                    <li class="dropdown">
                        <a href="#" style="text-decoration: none">
                            <img src="{{URL::asset('imagens/sbentes.jpg')}}"
                                 class="img-circle" width="26" height="26"
                                 style="margin-top: -3px">
                            <span id="underline">Sergio Bentes</span>
                        </a>
                    </li>
                    <li><a href="#"
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="center">
                                            <a href="{{URL::asset('produtos/'. $produto->imagem)}}"
                                               data-lightbox="{{URL::asset('produtos/'. $produto->imagem)}}">
